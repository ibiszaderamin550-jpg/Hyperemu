...
Java_com_hyperemu_renderer_GPUImage_createHardwareBuffer(JNIEnv *env, jclass obj, jshort width,
...
JNIEXPORT jlong JNICALL
Java_com_hyperemu_renderer_GPUImage_createImageKHR(JNIEnv *env, jclass obj,
                                                   jlong hardwareBufferPtr, jint textureId) {
    return (jlong)createImageKHR((AHardwareBuffer*)hardwareBufferPtr, textureId);
}

JNIEXPORT void JNICALL
Java_com_hyperemu_renderer_GPUImage_destroyHardwareBuffer(JNIEnv *env, jclass obj,
...
Java_com_hyperemu_renderer_GPUImage_lockHardwareBuffer(JNIEnv *env, jclass obj,
...
JNIEXPORT void JNICALL
Java_com_hyperemu_renderer_GPUImage_destroyImageKHR(JNIEnv *env, jclass obj, jlong imageKHRPtr) {
