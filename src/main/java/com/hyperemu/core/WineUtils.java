...
public abstract class WineUtils {
    public static void createDosdevicesSymlinks(Container container) {
        ...
        for (String[] drive : container.drivesIterator()) {
            ...
            if (!linkTarget.isDirectory() && path.endsWith("/com.hyperemu/storage")) {
                linkTarget.mkdirs();
    ...
    public static void applySystemTweaks(Context context, WineInfo wineInfo) {
        ...
        try (WineRegistryEditor registryEditor = new WineRegistryEditor(userRegFile)) {
            ...
            registryEditor.removeKey("Software\\HyperEmu\\WFM\\ContextMenu\\7-Zip");
            registryEditor.setStringValue("Software\\HyperEmu\\WFM\\ContextMenu\\7-Zip", "Open Archive", "Z:\\opt\\apps\\7-Zip\\7zFM.exe \"%FILE%\"");
            registryEditor.setStringValue("Software\\HyperEmu\\WFM\\ContextMenu\\7-Zip", "Extract Here", "Z:\\opt\\apps\\7-Zip\\7zG.exe x \"%FILE%\" -r -o\"%DIR%\" -y");
            registryEditor.setStringValue("Software\\HyperEmu\\WFM\\ContextMenu\\7-Zip", "Extract to Folder", "Z:\\opt\\apps\\7-Zip\\7zG.exe x \"%FILE%\" -r -o\"%DIR%\\%BASENAME%\" -y");
